...
("달려라 슛돌이", "슛돌이가 꿈이었던 청년들과 함께하는 축구크루", "2023-05-11", 2, "대전시" , 10, "ssafy7"),
("겨울보드", "겨울에만 활동하는 스케이트보드 크루입니다.", "2024-01-25", 3, "대전시", 8, "ssafy3"),
("테테레테테테니스", "테니스 파트너를 찾고 계시다면 바로 여기에요", "2023-10-10", 4, "대전시", 6, "ssafy3"),
("영차영차 등산크루", "매주 주말 오전에 모입니다.", "2023-11-18", 5, "대전시", 20, "ssafy5"),
("대롱대롱 요가크루", "초보자도 함께할 수 있는 요가 크루", "2023-11-20", 6, "대전시 유성구 궁동", 4, "ssafy2"),
("욜로족의 골프 투어", "젊을 때 신나게 살아요", "2023-12-12", 7, "대전시", 3, "ssafy6"),
("날다람쥐", "하늘을 날아보셨나요? 저희와 함께해요", "2023-09-20", 8, "대전시", 5, "ssafy7"),
("어푸어푸", "중급 이상의 실력을 가지신 분들 모집합니다", "2023-11-17", 9, "대전시", 10, "ssafy9"),
("들썩들썩 댄스스포츠", "댄스 스포츠! 당신도 할 수 있습니다!", "2023-12-24", 10, "대전시", 24, "ssafy10"),
("하체 맛있다", "같이 쇠질하실 분 구해요", "2023-11-24", 11, "대전시", 2, "ssafy3"),
("폴 인 럽", "진입장벽이 높은 만큼 더 재밌어요", "2023-04-28", 12, "대전시", 4, "ssafy1"),
("도도도도 발레크루", "유연성과 근력을 동시에 기를 수 있는 발레크루입니다", "2023-07-11", 13, "대전시", 7, "ssafy1"),
("강해지고싶나?", "줄넘기부터 빡세게 운동하실 분", "2023-12-12", 14, "대전시", 5, "ssafy3"),
("클라이밍조아", "초보자 환영해요. 함께 해요!", "2023-11-11", 15, "대전시", 10, "ssafy2"),
("으쌰으쌰 크로스핏", "체력을 기르고 싶다면 역시 크로스핏, 크루원 모집합니다", "2023-12-30", 16, "대전시", 12, "ssafy4"),
('운동매니아', '즐겁게 운동하며 건강한 삶을 추구하는 크루입니다', '2023-12-01', 3, '서울 강남구 역삼동', 10, 'ssafy4'),
...
('등산단', '등산을 통해 체력을 강화하며 아름다운 풍경을 즐기는 크루에요. 같이 올라봐요!', '2023-12-25', 10, '대전 서구 둔산동', 9, 'ssafy6'),
('테이블테니스 대결', '테이블테니스 실력을 겨루며 재미있는 대결을 즐기는 크루입니다', '2023-12-28', 6, '울산 북구 산하동', 16, 'ssafy7'),
('수영매니아', '수영을 즐기며 물 속에서의 특별한 경험을 나누는 크루입니다', '2024-01-10', 12, '서울 강동구 성내동', 7, 'ssafy1');
